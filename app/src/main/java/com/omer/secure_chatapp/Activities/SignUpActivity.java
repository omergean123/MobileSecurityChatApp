...
import com.omer.secure_chatapp.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void signUp(){
        ...
        user.put(Constants.KEY_IMAGE,encImage);
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    preferenceManager.putString(Constants.KEY_IMAGE, encImage);
    ...
    private Boolean isValidSignUpDetails(){
        if(encImage == null){
            ...
            showToasts("Password & confirm password must be the same");
            return false;
        }else{
            return true;
        }
